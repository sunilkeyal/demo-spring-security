package info.keyal.demo.tutorial.codility;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        numberOfSeason = 3;
        System.out.println(solution.interview(input, numberOfSeason));
    }
}

@SuppressWarnings("java:S106")
class Solution {
    public static int interview(int[] input, int numberOfSeason) {
